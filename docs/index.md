# BuildingOS 软件著作权文档中心

本项目用于集中整理与维护智能楼宇系列软件的著作权申报材料、使用手册与源代码页。这些内容以统一模板组织，便于规范填写、审核与归档。

> 说明：当前索引覆盖清单中提供的全部系统，共计 18 项。若需缩减至 15 项或调整名称，可直接编辑对应目录中的页面。

## 快速导航

- [智能楼宇访客系统 buildingos.visitor](/visitor/copyright)
...
- [智能楼宇会议平板APP buildingos.meetingpad](/meetingpad/copyright)
- [智能楼宇墙面平板APP buildingos.wallpad](/wallpad/copyright)
- [智能楼宇企业微信端 buildingos.wechat](/wechat/copyright)
- [智能楼宇飞书端 buildingos.feishu](/feishu/copyright)
...
- 每个系统包含三页文档：
  - 软件著作权内容：用于申报信息的结构化填写
  - 使用手册：操作说明或设计说明模板（含章节结构）
  - 源代码：申报所需的“前30页”和“后30页”占位页
- 填写时请遵循各字段的格式要求与约束说明。使用手册中需补充操作截图或设计图；源代码页需粘贴规范化代码片段。
